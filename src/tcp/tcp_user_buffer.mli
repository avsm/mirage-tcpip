...
module Rx : sig
  ...
  val create : max_size:int32 -> wnd:Tcp_window.t -> t
...
module Tx(Time:V1_LWT.TIME)(Clock:V1.MCLOCK) : sig
  ...
  module TXS : sig
    type t = Tcp_segment.Tx(Time)(Clock).t
    val output : ?flags:Tcp_segment.tx_flags -> ?options:Tcp_options.t list -> t ->
      Cstruct.t -> unit Lwt.t
  end

  val create: max_size:int32 -> wnd:Tcp_window.t -> txq:TXS.t -> t
